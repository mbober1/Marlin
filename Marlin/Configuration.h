...
#define STRING_CONFIG_H_AUTHOR "(Mbober)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CyberPrinter"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 86.98
  #define DEFAULT_bedKi 16.47
  #define DEFAULT_bedKd 306.18
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -10, -0.5 }
